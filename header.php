    ...
    <div class="container">
      ...
      <div class="nav-btn">
            ...
            <li class="nav-link" style="--i: .85s">
              ...
              <div class="dropdown">
                <ul>
                  ...
                  <li class="dropdown-link">
                    <a href="water.php">Water Plants</a>
            ...
            <li class="nav-link" style="--i: 1.1s">
              ...
              <div class="dropdown">
                <ul>
                  ...
                  <li class="dropdown-link">
                    <a href="#">Pots<i class="fas fa-caret-down"></i></a>
                    <div class="dropdown second">
                      <ul>
                        <li class="dropdown-link">
                  ...
                  <li class="dropdown-link">
                    <a href="#"></a>
                    <li class="dropdown-link">
                          <a href="#">Gardening Tools<i class="fas fa-caret-down"></i></a>
                          <div class="dropdown second">
                            <ul>
                              <li class="dropdown-link">
                                <a href="trowel.php">Trowel</a>
                              </li>
                              <li class="dropdown-link">
                                <a href="sprayer.php">Sprayer</a>
                              </li>
                              <!-- <li class="dropdown-link">
                                <a href="#">Link 3</a>
                              </li> -->
        ...
        <div class="log-sign" style="--i: 1.8s">
          <a href="login.php" class="btn transparent"> <?php echo "$username" ?></a>
          <a href="add_to_cart.php" class="btn transparent"><i class="fas fa-shopping-cart cart-icon"></i></a>
        </div>
